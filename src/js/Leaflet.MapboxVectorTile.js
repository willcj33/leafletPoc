/**
 * Created by willjaynes on 6/16/16.
 */
...
// return feature `i` from this layer as a `VectorTileFeature`
    ...
    function MVTFeature(mvtLayer, vtf, ctx, id, style, masterLayer) {
        if (!vtf) return null;
    ...
    MVTFeature.prototype.draw = function(canvasID, url) {
...
//  this.style = this.mvtLayer.style(this);
        ...
        switch (vtf.type) {
            case 1: //Point
                this._drawPoint(ctx, vtf.coordinates, style, url, vtf);
    ...
    MVTFeature.prototype._drawPoint = function(ctx, coordsArray, style, baseCanvas, vtf) {

        if (this.masterLayer) {
            var pos = ctx.canvas._leaflet_pos;
            var point = new L.Point(coordsArray[0][0].x / (this.divisor) + pos.x, coordsArray[0][0].y / (this.divisor) + pos.y);
            this.masterLayer.customDrawCanvas(baseCanvas, point);
        }
    ...
    module.exports = L.TileLayer.Canvas.extend({
        ...
        initialize: function(mvtSource, options) {
            ...
            var data   = '<svg height="35px" width="28px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns" version="1.1">\
                <g>\
                <path stroke="#fff" fill="#baab8d" d="M13,34 C13,34 25.9971964,24.4769584 26,13 C26,5.82029825 20.1797017,0 13,0 C5.82029825,0 0,5.82029825 0,13 C0.165217837,25.3733136 13,34 13,34 Z"/>\
                <path stroke="none" fill="#FFFFFF" d="M17.9560547,7 L8.04394531,7 C6.91601562,7 6,7.91601562 6,9.04394531 L6,18.9560547 C6,20.0839844 6.91601562,21 8.04394531,21 L17.9560547,21 C19.0839844,21 \
20,20.0839844 20,18.9560547 L20,9.04394531 C20,7.91601562 19.0839844,7 17.9560547,7 L17.9560547,7 Z M13,11.375 C14.4492188,11.375 15.625,12.5507812 15.625,14 C15.625,15.4492188 14.4492188,16.625 13,16.625 C11.5507812,\
16.625 10.375,15.4492188 10.375,14 C10.375,12.5507812 11.5507812,11.375 13,11.375 L13,11.375 Z M18.5439453,19.25 C18.5439453,19.4140625 18.4140625,19.5439453 18.25,19.5439453 L7.75,19.5439453 C7.5859375,19.5439453 \
7.45605469,19.4140625 7.45605469,19.25 L7.45605469,13.125 L9.0078125,13.125 C8.94628906,13.4052734 8.91894531,13.6992188 8.91894531,14 C8.91894531,16.2558594 10.7441406,18.0810547 13,18.0810547 C15.2558594,18.0810547 \
17.0810547,16.2558594 17.0810547,14 C17.0810547,13.6992188 17.0537109,13.4052734 16.9921875,13.125 L18.5439453,13.125 L18.5439453,19.25 Z M18.5439453,10.5 C18.5439453,10.6640625 18.4140625,10.7939453 18.25,10.7939453 \
L16.5,10.7939453 C16.3359375,10.7939453 16.2060547,10.6640625 16.2060547,10.5 L16.2060547,8.75 C16.2060547,8.5859375 16.3359375,8.45605469 16.5,8.45605469 L18.25,8.45605469 C18.4140625,8.45605469 18.5439453,8.5859375 \
18.5439453,8.75 L18.5439453,10.5 Z"/>\
                </g>\
                </svg>';
        ...
        parseVectorTileLayer: function(vtl, ctx) {
            ...
            for (var i = 0, len = features.length; i < len; i++) {
                ...
                if (!mvtFeature) {
                    ...
                    self.features[uniqueID] = mvtFeature = new MVTFeature(self, vtf, layerCtx, uniqueID, style, self.options.masterLayer);
                    if (style && style.dynamicLabel && typeof style.dynamicLabel === 'function') {
        ...
        redrawTile: function(canvasID) {
            ...
            for (var i = 0; i < features.length; i++) {
                var feature = features[i];
                if (feature.selected) {
                    selectedFeatures.push(feature, this.baseCanvas);
                } else {
                    feature.draw(canvasID, this.baseCanvas);
                }
            }
    ...
    function removeLabels(self) {
        ...
        if (!features) {self.featuresWithLabels = []; return;}
        for (var i = 0, len = features.length; i < len; i++) {
            var feat = features[i];
            feat.removeLabel();
        }
    ...
    module.exports = L.TileLayer.MVTSource = L.TileLayer.Canvas.extend({
        ...
        createMVTLayer: function(key, type) {
            ...
            var options = {
                ...
                style: self.style,
                name: key,
                masterLayer: self.options.masterLayer,
                asynch: true
            };
